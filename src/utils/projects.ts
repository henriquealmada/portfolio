...
import bookingProject from '../assets/booking-project.png'
...
import statsPreviewCardProject from '../assets/stats-preview-card-project.png'
import restaurantMenuProject from '../assets/restaurant-menu-project.png'
import accordionProject from '../assets/accordion-project.png'
import videoBackgroundProject from '../assets/video-background-project.png'
import weatherProject from '../assets/weather-project.png'
import adviceGeneratorProject from '../assets/advice-generator-project.png'
import testimonialsSliderProject from '../assets/testimonials-slider-project.png'
import controleFinanceiro from '../assets/controle-financeiro-project.png'
import countriesAPI from '../assets/countries-project.png'

import html from '../assets/HTML5-icon.png'
import css from '../assets/css-icon.png'
import javascript from '../assets/javascript-icon.webp'
import typescript from '../assets/typescript-icon.webp'
import react from '../assets/react-icon.png'
import next from '../assets/next-icon.png'
import node from '../assets/node-icon.webp'
...
export const projects = [
  {
    ...
    tools: [
      { category: 'React', icon: react },
      { category: 'Next.js', icon: next },
      { category: 'Node.js', icon: node },
      { category: 'MongoDB', icon: mongodb },
      { category: 'TypeScript', icon: typescript },
      { category: 'Tailwind CSS', icon: tailwind }
    ],
    image: pizzaProject,
  ...
  },
  {
    ...
    tools: [
      { category: 'HTML', icon: html },
      { category: 'CSS', icon: css }
    ],
  ...
  },
  {
    ...
    tools: [
      { category: 'HTML', icon: html },
      { category: 'CSS', icon: css },
      { category: 'JavaScript', icon: javascript }
    ],
